    ...
    <div class="sidebar">
      <div class="sidebar-menu">
        ...
        <li class="item" id="insentif">
            ...
            <div class="sub-menu">
                <a href="manajemenInsentif.php" target="isi"><i class=""></i><span>Manajemen Insentif</span></a>
            </div>
        </li>
        <li class="item" id="validasi">
            ...
            <div class="sub-menu">
                <a href="validasiLaporanWarga.php" target="isi"><i class=""></i><span>Validasi Laporan Warga</span></a>
            </div>
        </li>
        <li class="item">
